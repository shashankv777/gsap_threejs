...
import { animatieWithGsapTimeline } from '../utils/animation'
...
function Model() {
    ...
    useEffect(()=>{
        if(size==='large'){
            animatieWithGsapTimeline(timeline,small,smallRotation,'#view1','#view2',{
        ...
        if(size==='small'){
            animatieWithGsapTimeline(timeline,large,largeRotation,'#view2','#view1',{
